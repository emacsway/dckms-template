...
- "`OrgNote <https://about.org-note.com/>`__" - OrgNote is a text-based note-taking application that implements the Zettelkasten principle and allows you to create your own personal knowledge base. OrgNote is open source, and built on top of Org Roam, a popular package for GNU Emacs. (`Source Code <https://github.com/Artawower/orgnote>`__)
